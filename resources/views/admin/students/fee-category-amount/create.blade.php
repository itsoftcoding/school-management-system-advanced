    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Fee Category Amount</li>
            </ol>
        </nav>
    </div>
    <div class="ms-auto">
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.student.fee_category_amount.store') }}">
            @csrf
            <div class="add_item">
            <div class="mb-3">
                <label class="form-label">Fee Category:</label>
                <select class="form-select @error('student_fee_category_id') is-invalid @enderror" name="student_fee_category_id"
