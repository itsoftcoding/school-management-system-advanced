...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.subject.subject_assign.store') }}">
            @csrf
            <div class="add_item">
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('subject_id') is-invalid @enderror"
                                name="subject_id[]" aria-label="Default select example">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="number" name="full_mark[]" class="form-control @error('full_mark') is-invalid @enderror">
                            @error('full_mark')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="number" name="subjective_mark[]" class="form-control @error('subjective_mark') is-invalid @enderror">
        ...
        <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
           <div class="row">
            ...
            <div class="col-md-2">
                <div class="mb-3">
                    <label class="form-label">Subject Code</label>
                    <input type="number" name="subject_code[]" class="form-control @error('subject_code') is-invalid @enderror">
                    @error('subject_code')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-2" style="padding-top: 28px;">
                <button type="button" class="btn btn-success addeventmore"><i class="bx bx-plus font-22"></i></button>
