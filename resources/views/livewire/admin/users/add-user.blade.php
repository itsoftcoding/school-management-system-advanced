        ...
        <div class="card-body">
            <form method="POST" wire:submit.prevent="save">
                <div class="mb-3">
                    ...
                    <select class="form-select @error('role') is-invalid @enderror" wire:model="role" aria-label="Default select example">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" wire:model.lazy="email" class="form-control @error('email') is-invalid @enderror" placeholder="example@gmail.com">
                    @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
